...
const ReviewUploadMediaSheet: FC<Props> = ({ review, children }) => {
  ...
  const handleUploadMedia = () => {
    post(route('review.upload-media', review.id), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to review</SheetDescription>
        </SheetHeader>
...
export default ReviewUploadMediaSheet;
